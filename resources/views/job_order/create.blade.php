                ...
                <div class="card card-primary card-outline">
                    <div class="card-header">
                        ...
                        <div class="card-tools">
                            <a class="btn btn-sm btn-secondary no-shadow" href="{{ route('joborder.list') }}">
                                <i class="fas fa-hand-o-left"></i>Go Back
                            </a>
                        </div>
                    </div>
                    <!-- /.card-header -->
                        ...
                        <div class="row">
                            <div class="col-md-2">
                                <div class="form-group">
                                    <label class="control-label">WO No<span class="text-danger">*</span></label>
                                    <select name="wo_serial" id="id_wo_serial_drop" class="form-control"
                                            onchange="jobOrder.ivm.setWOSerialNoId()"></select>
                                </div>
                            </div>
                                        ...
                                        <div class="row">
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" class="form-control" id="id_mod_ins_comp_name"
                                                           data-bind="value: mod_ins_comp_name" readonly>
                                                </div>
                                            </div>
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    <label class="control-label">Policy No</label>
                                                    <input type="text" class="form-control" id="id_mod_ins_policy_no"
                                                           data-bind="value: mod_ins_policy_no" readonly>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="row">
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" class="form-control" id="id_mod_ins_expire_date"
                                                           data-bind="value: mod_ins_expire_date" readonly>
                                                </div>
                                            </div>
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    <label class="control-label">Phone Number</label>
                                                    <input type="text" class="form-control" id="id_mod_ins_phone_no"
                                                           data-bind="value: mod_ins_phone_no" readonly>
                                                </div>
                                            </div>
                                        </div>
                                    ...
                                    <div class="card-body">
                                        ...
                                        <div class="row">
                                            <div class="col-md-4">
                                                <div class="form-group">
                                                    <label class="control-label">Company Name</label>
                                                    <input type="text" class="form-control" id="id_mod_cont_comp_name"
                                                           data-bind="value: mod_cont_comp_name" readonly>
                                                </div>
                                            </div>
                                            <div class="col-md-4">
                                                <div class="form-group">
                                                    <label class="control-label">Contract No</label>
                                                    <input type="text" class="form-control" id="id_mod_cont_policy_no"
                                                           data-bind="value: mod_cont_policy_no" readonly>
                                                </div>
                                            </div>
                                            <div class="col-md-4">
                                                <div class="form-group">
                                                    <label class="control-label">Expire Date</label>
                                                    <input type="text" class="form-control" id="id_mod_cont_expire_date"
                                                           data-bind="value: mod_cont_expire_date" readonly>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="row">
                                            <div class="col-md-4">
                                                <div class="form-group">
                                                    <label class="control-label">Phone Number</label>
                                                    <input type="text" class="form-control" id="id_mod_cont_phone_no"
                                                           data-bind="value: mod_cont_phone_no" readonly>
                                                </div>
                                            </div>
                                            <div class="col-md-4">
                                                <div class="form-group">
                                                    <label class="control-label">Mileage</label>
                                                    <input type="text" class="form-control" id="id_mod_cont_mileage"
                                                           data-bind="value: mod_cont_mileage" readonly>
                                                </div>
                                            </div>
                                        </div>
                                    ...
                                    <div class="card-body">
                                        ...
                                        <div class="row">
                                            <div class="col-md-4">
                                                <div class="form-group">
                                                    <label class="control-label">Company Name</label>
                                                    <input type="text" class="form-control" id="id_mod_warr_comp_name"
                                                           data-bind="value: mod_warr_comp_name" readonly>
                                                </div>
                                            </div>
                                            <div class="col-md-4">
                                                <div class="form-group">
                                                    <label class="control-label">Warranty No</label>
                                                    <input type="text" class="form-control" id="id_mod_warr_warranty_no"
                                                           data-bind="value: mod_warr_warranty_no" readonly>
                                                </div>
                                            </div>
                                            <div class="col-md-4">
                                                <div class="form-group">
                                                    <label class="control-label">Date of Purchase</label>
                                                    <input type="text" class="form-control" id="id_mod_warr_dop"
                                                           data-bind="value: mod_warr_dop" readonly>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="row">
                                            <div class="col-md-4">
                                                <div class="form-group">
                                                    <label class="control-label">Expire Date</label>
                                                    <input type="text" class="form-control" id="id_mod_warr_expire_date"
                                                           data-bind="value: mod_warr_expire_date" readonly>
                                                </div>
                                            </div>
                                            <div class="col-md-4">
                                                <div class="form-group">
                                                    <label class="control-label">Phone Number</label>
                                                    <input type="text" class="form-control" id="id_mod_warr_phone_no"
                                                           data-bind="value: mod_warr_phone_no" readonly>
                                                </div>
                                            </div>
                                        </div>
...
{{--                                                <th class="text-center" style="">Qty</th>--}}
                                                ...
                                                <th class="text-center" style="">
                                                    <button type="button" class="btn btn-primary"
                                                            onclick="jobOrder.ivm.showServicePkgListMod()"><i
                                                            class="fas fa-plus"></i></button>
                                                </th>
                                            </tr>
                                            </thead>
                                            ...
                                            <tr>
                                                ...
                                                <td class="text-center"><i class="fa fa-trash-alt"
                                                                           ...
                                                                           data-toggle="tooltip" data-placement="top"
                                                                           title="Remove this row"
                                                                           data-bind="click: $parent.removeServGridRow.bind($data, $index())"></i>
                                                </td>
                                            </tr>
                                            </tbody>
                                        </table>
                        ...
                        <div class="callout callout-success">
                            ...
                            <!-- Start:Inventory item added table -->
                            <div class="row">
                                <div class="col-md-12">
                                    <div class="table-responsive">
                                        <table class="table table-condensed table-bordered">
                                            ...
                                            <tr>
                                                ...
                                                {{--                                            <th style="" class="text-center">Serial No</th>--}}
                            ...
                            <!-- End:Inventory item added table -->
                            <div class="row mt-3">
                    ...
                    <div class="card-footer">
                        <div class="">
                            ...
                            <div class="form-group">
                                ...
                                <button type="button" id="add_joborder" class="btn btn-success btn-sm float-right"
                                        onclick="jobOrder.ivm.formSubmit();"><i class="fas fa-save"></i> Submit
                                </button>
        ...
        jobOrder = {
            ...
            jobOrderViewModel: function () {
                ...
                self.designInitialize = () => {
                    select2Dropdown('id_wo_serial_drop', '{{ route('workorder.serialno.drop.list') }}')
                ...
                self.getWODetails = function () {
                    if(self.wo_serial() != "" && self.wo_serial() != "joborder-create") {
                        $.ajax({
                            ...
                            success: function (data, textStatus, jQxhr) {
                                ...
                                if (data.status) {
                                    ...
                                    self.woCustomerId(data.data[0].customer_id);
                ...
                /** not used **/
                self.setWOSerialNoId = () => {
                    self.wo_serial(getSelect2Val('id_wo_serial_drop'));
                    self.getWODetails();
                }
                ...
                self.insertJobOrder = function () {
                    $.ajax({
                        url: '{{route('joborder.create.submit')}}',
                        type: 'POST',
                        headers: {'X-CSRF-TOKEN': $('meta[name="csrf-token"]').attr('content')},
                        dataType: 'json',
                        data: {
                        ...
                        success: (responseData) => {
                            ...
                            setTimeout(function () {
                                window.top.location = "{{ url('/joborder-unapprove-cost-list') }}";
                            },200)
                        },
                        error: (jqXHR, textStatus, errorThrown) => {
                            StopLoading();
