                                ...
                                <div class="col-md-12">
                                    <div class="table-responsive">
                                        <table class="table table-condensed table-bordered table-hover mb-0">
                                            ...
                                            <tr>
                                                <td data-bind="text: col1" class="text-center p-0 pt-1"></td>
                                                ...
                                                <td data-bind="text: col7" class="text-right p-0 pt-1">DisAmount</td>
                                            </tr>
                                            <!-- items -->
                                ...
                                <div class="col-md-12">
                                    <div class="table-responsive">
                                        <table class="table table-condensed table-bordered table-hover mb-0">
                                            ...
                                            <tr>
                                                <td data-bind="text: col1" class="text-center p-0"></td>
                                                <td data-bind="text: col2" class="text-center p-0"></td>
                                                <td data-bind="text: col3" class="text-center p-0"></td>
                                                <td data-bind="text: col4" class="text-right p-0"></td>
                                                <td data-bind="text: col5" class="text-right p-0"></td>
                                            </tr>
                                            </tbody>
                                        </table>
                                    </div>
                                    ...
                                    <div class="table-responsive">
                                        <table class="table table-condensed table-bordered">
                                            ...
                                            <tr data-bind="attr: { data_item_id: item_id, id: 'row_'+item_id(), class: validateClass1(), title: item_row_tooltip() }" data-toggle="tooltip" data-placement="left">
                                                ...
                                                <td class="text-right p-0 pt-1" data-bind="style: { display: jobOrder.ivm.is_product_discount() == 1 ? '' : 'none' }">
                                                ...
                                                <td class="text-right p-0 pt-1" data-bind="style: { display: jobOrder.ivm.is_tax1() == 1 ? '' : 'none' }">
    ...
    <script>
        ...
        jobOrder = {
            ...
            jobOrderViewModel: function () {
                ...
                self.inv_date = ko.observable("{{ $editData->date }}");

                self.jo_serial = ko.observable("");
                self.jo_id = ko.observable("{{ $editData->jo_id }}");
                ...
                self.getInvoiceDetails = function () {
                    if(self.itemID() != "") {
                        $.ajax({
                            url: "{{ route('invoice.selected.data') }}",
                            dataType: 'json',
                            type: 'get',
                ...
                let gridItemListRows = function (obj, state) {
                    ...
                    if (state == "up") {
                        ...
                        // console.log(obj.row.service_pkg_id);
                        let itemType = '';
                        if(item.service_pkg_id !== null && item.service_pkg_id() != "" && item.service_pkg_id() != 0) itemType = 'serv';
                        ...
                        console.log(item.item_price_raw())
